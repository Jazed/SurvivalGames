...
public class UpdateChecker {
    ...
    public void check(Player player, Plugin p){
        ...
        try{
            ...
            URL url = new URL("http://curlybrace.org/sg/updatecheck.php");
           ...
           // System.out.println(in[0]+b);
            if(b){
                ...
                player.sendMessage(ChatColor.DARK_RED+"[SurvivalGames] Updated Avaliable!");
                ...
                System.out.println("[info]No updates found!");
            }
